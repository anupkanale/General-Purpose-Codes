function uFourier = fourierSum(N,fLoc,rVecM,rVec,fVec,alpha,L,a1,a2,a3,nImag)
    uFourier = 0;
    ...
    for kk=1:(2*nImag+1)^3
        ...
        if kMag~=0
            ...
            for ii=1:N
                fFourier = fFourier + fVec(:,fLoc(ii))...
                    * exp(2*pi*1j*kVec'*rVec(:,fLoc(ii)));
            end
